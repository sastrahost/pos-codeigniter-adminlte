                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="hidden" name="retur_penjualan_id" id="retur_penjualan_id" value="<?php echo !empty($code_retur_penjualan) ? $code_retur_penjualan : '';?>"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="kode">Kode Penjualan</label>
                     <div class="col-sm-8">
                       ...
                       <input type="hidden" name="code_penjualan" id="retur_code_penjualan" value="<?php echo !empty($code_penjualan) ? $code_penjualan : '';?>"/>
                     </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="hidden" name="retur_penjualan_date" value="<?php echo !empty($date) ? $date : date('Y-m-d H:i:s');?>" id="retur_penjualan_date" class="form-control"/>
                    </div>
                  </div>
                  <?php if(!empty($edit) && $edit){?>
                  <div class="form-group">
